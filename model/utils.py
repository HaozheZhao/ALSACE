...
PROMPT_MODELS = {
    ...
    "xlm-roberta": {
        # TaskType.SEQUENCE_CLASSIFICATION: RobertaPromptForSequenceClassification,
        # TaskType.MULTIPLE_CHOICE: RobertaPromptForMultipleChoice,
        TaskType.LANGUAGE_MODELING: XLMRobertaForMaskedLM
    },
    "mt5":{
        TaskType.LANGUAGE_MODELING: MT5ForConditionalGeneration
    },
    "xlm":{
        TaskType.LANGUAGE_MODELING: XLMWithLMHeadModel
    },
    "xlm-roberta-xl":{
        TaskType.LANGUAGE_MODELING: XLMRobertaXLForMaskedLM

    },
    "xglm":{
        TaskType.LANGUAGE_MODELING: XGLMForCausalLM
