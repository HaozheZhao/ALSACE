...
from tasks.xtreme.dataset import (
    XtremeDataset
)
...
def get_trainer(args):
    ...
    if model_args.task_type == "sequence_classification":
        dataset = XtremeDataset(tokenizer, model_args, data_args, training_args)
    elif model_args.task_type == "language_modeling":
        dataset = XtremeDataset(tokenizer, model_args, data_args, training_args, config)
